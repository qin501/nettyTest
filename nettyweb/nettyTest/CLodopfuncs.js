(function (win) {
        var CLODOP = {
        strWebPageID:"08AAAAJ",strTaskID:"",strHostURI:"http://localhost:8000",
        VERSION:"6.2.2.6",IVERSION:"6226",CVERSION:"3.0.8.3",HTTPS_STATUS:0,VERSION_EXT:false,
                        ...
                        try {
                                if (!this.webskt || this.webskt.readyState==3) {
                                    //c_webskt
                                        ...
                                        this.webskt=new WebSocket('ws://192.168.1.6:8090/ws');
